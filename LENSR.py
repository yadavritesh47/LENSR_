...
if section == "🎬 Movie Recommendation":
    ...
    if selected_movie:
        ...
        for i in indexes[0][1:]:
            ...
            card = f"""
                <div style='background: linear-gradient(to bottom right, #ffffff, #f0f0ff); padding:12px; border-radius:16px; box-shadow:0 8px 16px rgba(0,0,0,0.15); text-align:center; margin-bottom:20px; width:250px; height:530px; margin-left:auto; margin-right:auto;'>
